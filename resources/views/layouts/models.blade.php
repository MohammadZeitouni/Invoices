						...
						<div class="action-header clearfix">
							<div class="float-left hidden-xs d-flex ml-2">
								<div class="img_cont mr-3">
									<img src="{{URL::asset('assets/img/faces/6.png')}}" class="rounded-circle user_img" alt="img">
								</div>
						...
						<div class="card-body msg_card_body">
							...
							<div class="d-flex justify-content-start">
								<div class="img_cont_msg">
									<img src="{{URL::asset('assets/img/faces/6.png')}}" class="rounded-circle user_img_msg" alt="img">
								</div>
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content bg-dark border-0 text-white">
					<div class="modal-body mx-auto text-center p-7">
						<h5>Zeitouni Video call</h5>
						<img src="{{URL::asset('assets/img/faces/6.png')}}" class="rounded-circle user-img-circle h-8 w-8 mt-4 mb-3" alt="img">
